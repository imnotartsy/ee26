...
HD_PWD='Z:/ee/ee26/lab0/lab1/lab1.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log bit4_RC_adder_TB.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source bit4_RC_adder_TB.tcl
